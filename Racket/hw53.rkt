#|  hw#53
    ...
    worked with Nathaniel Beylison
    help from Nicole Shin
--------------------------------------------
...
; 4
(display "#4 reverseOfList") (newline)(newline)
#| --------------------------------------------
Structuring questions for recursive problems
0  structure of the problem
---------------------------
0a. What problem are you asked to solve?
    ...
    What does "size" mean in the context of that problem?
...
0c. What information do you have to be told? That is, what information has to be supplied as parameters?
     A list
...
1a. What problem can Mr. Brooks solve? Use your answers to 0a 
    to describe the same problem, except smaller in size,
    according to your meaning for "size".
     Mr. Brooks can reverse a list one element smaller than my list


1b. What sub-problem will you ask Mr. Brooks to solve? 
     a list with one element smaller than the given list
    How will you use Mr. Brooks's answer to construct your own?
     use car L and append it to the cdr L
...
;; cases requiring multiple recursive calls
(display (ROL '(17 18 19) ))
(display " ...should be") (newline) 
(display "(19 18 17)") (newline)
(display "-----------------") (newline) (newline)
